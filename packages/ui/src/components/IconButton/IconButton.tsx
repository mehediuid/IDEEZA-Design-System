...
export const iconButtonVariants = cva(
  ...
  ],
  {
    variants: {
      ...
      size: {
        sm: "size-[32px] rounded-[6px] [&_svg]:size-[16px]",
        md: "size-[40px] rounded-[8px] [&_svg]:size-[20px]",
        lg: "size-[44px] rounded-[8px] [&_svg]:size-[20px]",
        xl: "size-[48px] rounded-[8px] [&_svg]:size-[24px]",
      },
    },
